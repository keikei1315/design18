...
window.addEventListener("load",function(){
  setTimeout(function(){document.querySelector('.loading').classList.add('close')},500)
})
...
window.addEventListener("load", function(){
  setTimeout(function(){for (let i = 0; i < picAllLeft.length; i++){
    picAllLeft[i].style.animationDelay = (i*.2)+'s';
    picAllLeft[i].classList.add('start');
}
  for (let i = 0; i < picAllRight.length; i++){
    picAllRight[i].style.animationDelay = (i*.2)+'s';
    picAllRight[i].classList.add('start');
  }},500)
...
document.querySelector('.QandAMenu4').addEventListener("click", function() {
    this.classList.toggle("active");
    document.querySelector(".AnswerArea4").classList.toggle("open");
    document.querySelector(".questionAreaLi4").classList.toggle("open");
  })
  // QandA
